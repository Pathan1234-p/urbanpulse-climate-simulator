...
From the project folder (after [GitHub CLI](https://cli.github.com/) is installed):
...
This creates a public repo `urbanpulse-climate-simulator` and pushes the `main` branch.
